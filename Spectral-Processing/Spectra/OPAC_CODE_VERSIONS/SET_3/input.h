...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_HD189-PICKET-ALL-CLOUDS_phase_0.0_inc_0.00.00.0"      /* output name */
#define T_P_3D_FILE "DATA/init_HD189-PICKET-ALL-CLOUDS_phase_0.0_inc_0.0.txt"         /* input file */
...
#define CHEM_FILE   "DATA/eos_solar_doppler_with_el.dat"
