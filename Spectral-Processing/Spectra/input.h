...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_WASP-43b-ALL-core2_phase_240.0_inc_0.00.00.0"      /* output name */
#define T_P_3D_FILE "DATA/init_WASP-43b-ALL-core2_phase_240.0_inc_0.0.txt"         /* input file */
...
#define INPUT_PHASE 240.0              /* Planet inclination in degrees           */
#define G 47.02                   /* Planet surface gravity                 */

#define R_PLANET 74070000.0              /* Planet radius at base of atmosphere      */
#define ORB_SEP 3193394248.2979274                // This is some distance
#define STELLAR_TEMP 6432.0      // Stellar Blackbody temperature
#define R_STAR 917628300.0                  /* Stellar radius                         */
