...
#define LAMBDA_START <<LAMBDA_START>>       /*The start of the lambda index you want to calculate*/
#define LAMBDA_END <<LAMBDA_END>>           /*The end of the lambda index you want to calculate*/
