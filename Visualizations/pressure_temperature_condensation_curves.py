...
def plot_PTC_curves(planet_names, nlat, nlon, nlev, num_orders_of_magnitude):
    ...
    for ind, planet_name in enumerate(planet_names):
        ...
        if clouds:
            press_con, kcl, zns, na2s, mns, cr, sio2, mg2sio4, vo, ni, fe, ca2sio4, catio3, al2o3, mgsio3 = np.loadtxt(
                condensation_data, unpack=True)
            ...
            axes.semilogy(f_kcl(new_pressures), new_pressures, lw=2, label='KCl', color=cloud_colors[0])
